...
struct Triangle {
    ...
    Triangle() : enabled(false), length_enabled(false), length_val(0), timer_period(0), timer_val(0), duty_val(0),
                 counter_period(0), counter_val(0), counter_reload(false) {}
};
...
public:
    ...
    DMC() : enabled(false), value(0), samp_addr(0), samp_len(0), cur_addr(0), cur_len(0), shift_reg(0), bit_count(0),
            tick_period(0), tick_val(0), loop(false), irq(false) {}
